...
void loop() {
  ...
  colorWipe(strip.Color(0, 0, 0), 1000); // Red
...
void colorWipe(int c, int wait) {
  for(int i=0; i<strip.numPixels(); i++) {
      ...
      strip.setPixelColor(i-20, strip.Color(0,0,255));
      strip.setPixelColor(i-21, strip.Color(0,0,0));

      strip.setPixelColor(i-30, strip.Color(127,127,127));
  ...
  for(int i=strip.numPixels(); i>=0; i--) {
      ...
      strip.setPixelColor(i-31, strip.Color(255,0,0));
      strip.setPixelColor(i-30, strip.Color(0,0,0));

      strip.setPixelColor(i-21, strip.Color(0,255,0));
      strip.setPixelColor(i-20, strip.Color(0,0,0));

      strip.setPixelColor(i-11, strip.Color(0,0,255));
      strip.setPixelColor(i-10, strip.Color(0,0,0));

      strip.setPixelColor(i-1, strip.Color(127,127,127));
